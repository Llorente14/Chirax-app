...
/// Dialog Detail Badge - Trading Card Style (REACTIVE VERSION)
class BadgeDetailDialog extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(() {
      // Get the live badge from controller (reactive)
      final badge = controller.badges.firstWhereOrNull((b) => b.id == badgeId);

      // If badge not found, close dialog
      if (badge == null) {
